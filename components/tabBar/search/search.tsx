...
const damageStatusData: Data[] = [
    ...
    { label: "Existing Damages", value: "existing", icon: <AntDesign name="exclamationcircleo" size={20} color="#f59e0b" /> },
    { label: "No Damages", value: "no-damage", icon: <AntDesign name="check" size={24} color="#10b981" /> },
];

const defectsData: Data[] = [
    { label: "Checklist Defect", value: "checklist-defect", icon: <MaterialIcons name="checklist-rtl" size={24} color="#ef4444" /> },
    { label: "Safety Audit Issue ", value: "safety-audit", icon: <MaterialCommunityIcons name="truck-remove-outline" size={24} color="#ef4444" /> }
]
...
const subLocationData: Data[] = [
    { label: "Jedox Couriers", value: "jedox-couriers" },
]

// Dummy data for pagination table
const paginationData = [
    { title: 'Vehicle Info', data: ["KT24CKL - W1V3HBFZ1SP717923", "KT24CKL - W1V3HBFZ1SP717923", "qwfdqf - W1V3HBFZ1SP717923", "mytty - W1V3HBFZ1SP717923"] },
    {
        title: 'Date', data: ['8th Sep 2025 04:24', '8th Sep 2025 04:24', '8th Sep 2025 04:24', '8th Sep 2025 04:24']
    },
    { title: 'Make & Model', data: ['Mercedes-Benz Sprinter', 'Mercedes-Benz Sprinter', 'Mercedes-Benz Sprinter', 'Mercedes-Benz Sprinter'] },
    ...
    { title: 'Inspection type', data: ['End of Shift Inspection', 'End of Shift Inspection', 'End of Shift Inspection', 'End of Shift Inspection'] },

...
import { useAssessment } from '@/components/tabBar/more/assessment/assessment';
        ...
        >
            <ScrollView className='flex-1'>
                <View className='p-4 gap-4'>
                    <Card className='gap-5 bg-base-100 dark:bg-base-100-dark'>
                        <View>
                    ...
                    <Card className='bg-base-100 dark:bg-base-100-dark'>
                        <View className='border-b border-accent'>
                            <Text variant={"h4"} className='p-2'>Uploads</Text>
                        </View>
                        <View className='py-6 gap-3 items-center border-b border-accent/25'>
                            ...
                            <FontAwesome name="cloud-upload" size={68} color={colors.baseContent} />
